...
def draw_net_data():
    ...
    if get_default_interface_name() != None:
        ipv4_data = list(interfaces[get_default_interface_name()])
...
def draw_usage_chart(cpu, net):
    ...
    chart.addstr(6, 1, "watt", fmt_data["field-name-accent"])
    ...
    draw_bar_chart(2 * int(sens["in0"]["in0"] * sens["curr1"]["curr1"]), chart, 6, 6)
